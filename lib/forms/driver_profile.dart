...
import 'package:cccd/file/file_picker_stub.dart'; // Import the conditional file picker
...
class _ProfileCompletionScreenState extends State<ProfileCompletionScreen> {
  ...
  TextEditingController dateOfBirthTextEditingController =
      TextEditingController();
  TextEditingController driversLicenseNumberTextEditingController =
      TextEditingController();
  TextEditingController driversLicenseExpiryTextEditingController =
      TextEditingController();
  TextEditingController socialSecurityNumberTextEditingController =
      TextEditingController();
  ...
  Future<void> pickImageAndSetState(String imageType) async {
    ...
    if (pickedFile != null && kIsWeb) {
      ...
      setState(() {
        if (imageType == 'driverPhoto') {
          ...
          driverPhotoBytes = bytes; // Store the image bytes
  ...
  Future<String> uploadImage(XFile? imageFile, String imageName) async {
    ...
    String imageIdName =
        DateTime.now().millisecondsSinceEpoch.toString() + "_" + imageName;
          ...
          child: ListView(
            children: <Widget>[
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () => pickImageAndSetState('driverPhoto'),
                        child: CircleAvatar(
              ...
              TextFormField(
                ...
                decoration:
                    InputDecoration(labelText: 'Driver\'s License Expiry Date'),
                validator: (value) {
                  if (value!.isEmpty) {
                ...
                onTap: () async {
                  ...
                  driversLicenseExpiryTextEditingController.text =
                      dateFormat.format(date);
                },
              ),
              TextFormField(
              ...
              ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => pickImageAndSetState('driversLicense'),
                ),
              ),
              ...
              ListTile(
                ...
                trailing: IconButton(
                  icon: Icon(Icons.camera_alt),
                  onPressed: () => pickImageAndSetState('vehicleInsurance'),
                ),
              ),
              ...
              ListTile(
                ...
                trailing: IconButton(
                  icon: Icon(Icons.camera_alt),
                  onPressed: () => pickImageAndSetState('vehicleRegistration'),
                ),
              ),
              vehicleRegistrationPhoto == null
                  ? Text('No image selected.')
                  : kIsWeb
                      ? Image.network(vehicleRegistrationPhoto!.path,
                          errorBuilder: (context, error, stackTrace) {
                          return Text('Could not load image');
                        }, height: 100)
                      : Image.file(File(vehicleRegistrationPhoto!.path),
                          height: 100),
              const SizedBox(height: 20),
                  ...
                  if (_formKey.currentState!.validate() &&
                    ...
                    if (driverPhoto == null) {
                      cmethods.displaySnackbar(
                          'Please select a driver photo', context);
                    }
                  }
                },
                child: Text('Submit'),
  ...
  Future<void> saveProfileCompletionDetails() async {
    ...
    String driversLicenseUrl =
        await uploadImage(driversLicensePhoto, 'drivers_license');
    String vehicleInsuranceUrl =
        await uploadImage(vehicleInsurancePhoto, 'vehicle_insurance');
    String vehicleRegistrationUrl =
        await uploadImage(vehicleRegistrationPhoto, 'vehicle_registration');
      ...
      if (driverFirebase != null) {
        ...
        Map<String, dynamic> profileCompletionData = {
          ...
          'drivers_license_number':
              driversLicenseNumberTextEditingController.text,
          'drivers_license_expiry':
              driversLicenseExpiryTextEditingController.text,
          'social_security_number':
              socialSecurityNumberTextEditingController.text,
